    ...
    <div className="space-y-1">
      <div className="relative">
        <input
          ...
          className={cn(
            'h-8 w-full min-w-0 rounded-lg border border-input bg-transparent px-2.5 py-1 pr-9 font-mono text-base transition-colors outline-none placeholder:font-sans focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-input/50 disabled:opacity-50 aria-invalid:border-error aria-invalid:ring-3 aria-invalid:ring-error/20 md:text-sm dark:bg-input/30 dark:disabled:bg-input/80',
            className
          )}
        />
        {state === 'valid' && (
          <span className="absolute inset-y-0 right-0 flex items-center px-2.5 text-success">
