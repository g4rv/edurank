...
export const STAKE_TERMS = {
  kst: {
    ...
    lines: [
      ...
      'У положенні його позначають «Кст». Розподілити більше, ніж виділено, система дозволяє — перевищення просто показується.',
    ],
  },
  knpp: {
  ...
  remaining: {
    ...
    lines: [
      ...
      'Саме цей залишок ви й розподіляєте вручну. Червоне число означає перевищення фондів.',
    ],
  },
  bonus: {
    title: 'Здобувачі',
