...
export const STAKE_TERMS = {
  kst: {
    ...
    lines: [
      ...
      'Сума в колонці «Розподілено» не може перевищити цю кількість.',
    ],
  },
  knpp: {
  ...
  distributed: {
    ...
    lines: [
      ...
      'Не може перевищити виділені ставки: інакше зміни не збережуться.',
    ],
  },
  remaining: {
    title: 'Нерозподілено',
    lines: [
      ...
      'Залишок — це нормально. Червоне число означає, що виділене перевищено і треба комусь зменшити ставку.',
    ],
  },
  bonus: {
    ...
    lines: [
      ...
      'Виплачується ПОНАД виділені ставки — не входить до них і не конкурує з колегами.',
    ],
  },
  total: {
    title: 'Разом',
    lines: [
      ...
      'Сума по кафедрі може бути більшою за виділені ставки — рівно на суму бонусів.',
    ],
  },
  formula: {
    title: 'За формулою',
    lines: [
      'Скільки формула пропонує цій людині: 0,5 × (її рейтинг / середній по кафедрі) × (виділені ставки / Кнпп).',
