...
export const STAKE_TERMS = {
  ...
  bonusPool: {
    title: 'Бонусний пул',
    lines: [
      'Другий пул кафедри, який адміністрація виділяє пізніше — за залучених здобувачів і адміністративні посади.',
      'Формула його не чіпає. Розподіляється лише вручну, тому перший розподіл від нього захищений.',
    ],
  },
  status: {
